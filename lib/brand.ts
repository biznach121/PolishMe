...
export const brand: Brand = {
  name: "Polish Me Studio",
  shortName: "Polish Me",
  microTag: "POLISHED TO PERFECTION",
  description:
    "Polish Me Studio in Kumasi is where nails get the time and detail they deserve — clean sets, careful prep and finishes that last.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0546429190",
    phoneTel: "+233546429190",
    textPhone: "0256592545",
    textPhoneTel: "+233256592545",
    email: "hello@polishme.test",
    privacyEmail: "privacy@polishme.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@polishmestudio", icon: "tiktok" },
  ],
  ...
  hero: {
    ...
    subtitle:
      "Manicures, pedicures and nail art in Kumasi — walk in or book your slot",
  ...
  editorial: {
    ...
    notes: [
      {
        body: "Between work and everything else, Kumasi does not slow down for anyone — and your body keeps the score of every rushed week.",
        className: "left-[5%] top-[25%] max-w-[330px]",
      },
      {
        body: "At Polish Me Studio, self-care is not a someday luxury. It is an hour that fits into your actual life and pays you back all week.",
    ...
    images: [
      {
        ...
        alt: "Polish Me Studio beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Polish Me Studio self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Polish Me Studio beauty ritual",
      ...
      },
      {
        ...
        alt: "Polish Me Studio calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Polish Me Studio relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Polish Me Studio beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Polish Me Studio lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Polish Me Studio mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Polish Me Studio makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Polish Me Studio foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@polishmestudio",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783489163/stage4/spa_polishmestudio/tiktok_0.mp4",
        alt: "Polish Me Studio treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783489165/stage4/spa_polishmestudio/tiktok_1.mp4",
        alt: "Polish Me Studio treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581429/hptukehgmrufp33qyd5e.mp4",
        alt: "Polish Me Studio salon media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "Polish Me Studio self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "Polish Me Studio studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Polish Me Studio",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Polish Me Studio is a curated beauty and self-care space in Kumasi, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Kumasi. Use the Location page for the exact Google Maps pin, or call 0546429190 and text 0256592545 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0546429190, text 0256592545, or message @polishmestudio on Instagram." },
          ...
          { q: "Where are you located?", a: "Polish Me Studio is in Kumasi. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@polishme.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Polish Me Studio (\"we\", \"us\") is a beauty and self-care business in Kumasi, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@polishme.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Polish Me Studio is in Kumasi. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@polishme.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Polish Me Studio",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0546429190", href: "tel:+233546429190" },
      { label: "Text", value: "0256592545", href: "sms:+233256592545" },
      { label: "Instagram", value: "@polishmestudio", href: "https://www.tiktok.com/@polishmestudio" },
    ],
  },
  ...
  footer: {
    logoUrl: "https://res.cloudinary.com/dzykdnbvb/image/upload/v1783489154/stage4/spa_polishmestudio/avatar.jpg",
    blurb:
      "Polish Me Studio in Kumasi — polished to perfection.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@polishmestudio" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0546429190", href: "tel:+233546429190" },
          { label: "Text 0256592545", href: "sms:+233256592545" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Polish Me Studio — beauty and self-care in Kumasi. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
