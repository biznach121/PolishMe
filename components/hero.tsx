...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#752600] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#852c07]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(77, 19, 0,0.58),rgba(106, 14, 0,0.22)_43%,rgba(79, 24, 2,0.34)),linear-gradient(0deg,rgba(41, 14, 4,0.18),rgba(41, 14, 4,0.08))]" />
