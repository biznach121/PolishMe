...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783489153/stage4/spa_polishmestudio/logo.svg";
...
const LOGO_WHITE = "https://res.cloudinary.com/dzykdnbvb/image/upload/v1783525614/stage4/spa_polishmestudio/reallogo_white.png";
const LOGO_COLOR = "https://res.cloudinary.com/dzykdnbvb/image/upload/v1783525606/stage4/spa_polishmestudio/reallogo.png";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="Polish Me Studio - Polished to perfection">
        <Image
          src={src}
          alt="Polish Me Studio - Polished to perfection"
          fill
