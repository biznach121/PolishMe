  ...
  return (
    <section className="spabox-page">
      <div className="spabox-shell max-w-[760px] text-center">
        ...
        {error.digest && (
          <p className="mt-6 text-xs font-mono text-[#5b2d2d]/60">
            Reference: <code className="text-[#4e1b1e]">{error.digest}</code>
          </p>
        )}
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/"
            className="inline-flex min-h-14 items-center justify-center border border-[#4e1b1e]/18 px-7 text-sm font-semibold text-[#4e1b1e] transition-colors hover:bg-[#e2d0b9]"
          >
            Back home
          </Link>
        </div>
